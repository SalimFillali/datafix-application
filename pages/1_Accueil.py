...
def creuse_image_url() -> str:
    ...
    # Fallback : paysage rural français (Unsplash)
    return (
...
st.markdown(
    f"""
<div class="express">
  <div class="section-eyebrow" style="margin-bottom:1rem;">Recommandation express</div>
  <h3>Quel film aimez-vous ?</h3>
  <p>Cliquez sur un titre pour obtenir des recommandations instantanées.</p>
  <div class="express-grid">{express_cards_html}</div>
</div>
""",
    unsafe_allow_html=True,
)
...
<div class="footer">
  ...
  <div>Wild Code School · Cinéma de la Creuse · 2026</div>
